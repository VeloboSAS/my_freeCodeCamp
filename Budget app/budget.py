...
class Category:
    ...
    def deposit(self, amount, description=""):
        ...
        it should default to an empty string. The method should append an object to the ledger list in the form of
    ...
    def withdraw(self, amount, description=""):
        ...
        ledger as a negative number. If there are not enough funds, nothing should be added to the ledger.
    ...
    def transfer(self, amount, category):
        ...
        [Destination Budget Category]". The method should then add a deposit to the other budget category
        with the amount and the description "Transfer from [Source Budget Category]". If there are not
        enough funds, nothing should be added to either ledgers. This method should return True if the transfer
